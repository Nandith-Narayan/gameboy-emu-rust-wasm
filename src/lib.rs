...
lazy_static! {
    static ref GB_CPU: Mutex<CPU> = Mutex::new(CPU{ reg: [0; 8], pc: 0, sp: 0, interrupt_master_enable: false, mem: core::memory::init_memory(), ppu: core::ppu::init_ppu(), frame_done: false, unique_ops:vec![0], total_cycles:0});
}
